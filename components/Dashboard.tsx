                                    ...
                                    <div className="shrink-0 flex items-center mt-1 sm:mt-0">
                                        {nextJourneyStep.statusSource === 'manual' ? (
                                            ...
                                            <button
                                                ...
                                                className="px-3 py-1 bg-[#0066CC]/90 backdrop-blur-md border border-white/20 hover:bg-[#0055B3] text-white rounded-full text-[10px] font-black transition-all flex items-center gap-1 cursor-pointer font-['Plus_Jakarta_Sans'] uppercase tracking-wider shadow-sm"
                                            >
                                                <span>Open ↗</span>
                                            </button>
                                        )}
    ...
    return (
        <div onClick={onClick} className="col-span-1 bg-white rounded-[2.5rem] p-8 md:p-10 border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.03)] flex flex-col cursor-pointer hover:shadow-lg transition-all min-h-[450px] h-full relative">
            ...
            <div className="mt-4 text-right">
                <span className="text-sm font-semibold text-[#0066CC] flex items-center gap-1 justify-end">View Tracker <ArrowRight className="w-4 h-4"/></span>
            </div>
        </div>
    );
}
...
const LiveMarquee = ({ items, onNavigate, dark }: { items: any[], onNavigate: (route: string) => void, dark?: boolean }) => {
    if (items.length === 0) {
        return (
            <div className="bg-[#0066CC]/90 backdrop-blur-md border border-white/20 text-white py-3 px-4 rounded-2xl mb-8 flex items-center shadow-md shadow-sky-600/20">
    ...
    return (
        <div className="overflow-hidden whitespace-nowrap bg-[#0066CC]/90 backdrop-blur-md border border-white/20 text-white py-3 px-4 rounded-2xl mb-8 flex items-center shadow-md shadow-sky-600/20">
            <div className="flex items-center gap-2 pr-4 border-r border-white/20 mr-4 shrink-0 bg-[#0066CC]/90 z-10">
    ...
    return (
        <div onClick={onClick} className="col-span-1 bg-white rounded-[2.5rem] p-8 md:p-10 border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.03)] flex flex-col justify-between cursor-pointer hover:shadow-lg transition-all min-h-[450px] h-full relative">
            ...
            <div className="mt-6 pt-6 border-t border-slate-100 flex items-end justify-end">
                <span className="text-sm font-semibold text-[#0066CC] flex items-center gap-1">Action Tracker <ArrowRight className="w-4 h-4"/></span>
            </div>
        </div>
    );
}
...
const Dashboard: React.FC<DashboardProps> = ({ activeTier, fullBoq, projectContext, setActiveTab, setProjectContext, activeProject, setActiveProject, tiers, bank, projectId, projectArchitecture, onUpgradeArchitecture, onModifyBrief }) => {
    ...
    const finalTodayItems = nextActionsList.map(a => ({
        ...
        badgeColor: a.priority === 'blocker' ? 'bg-rose-50 text-rose-700 border-rose-100' : 'bg-sky-50 text-[#0055B3] border-sky-100'
    }));
                            ...
                            <>
                                {currentStageNum === 1 && (
                                    <button
                                        ...
                                        className="px-5 py-2.5 bg-[#0066CC]/90 hover:bg-[#0055B3] text-white backdrop-blur-md border border-white/20 text-xs font-bold rounded-full shadow-md shadow-sky-600/20 transition-all flex items-center gap-1.5"
                                    >
                        ...
                        <div className="bg-slate-50/50 border border-slate-100/80 rounded-[24px] p-6 mt-2 w-full">
                            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                                ...
                                <div className="flex items-center gap-4">
                                    <div className="w-12 h-12 rounded-2xl bg-[#0066CC]/90 text-white flex items-center justify-center shadow-lg shadow-sky-600/20 backdrop-blur-md border border-white/20 shrink-0">
                                        {activeStage.icon("w-6 h-6 stroke-[2]")}
                                    </div>
                                    <div>
                                        <div className="text-[10px] font-black uppercase tracking-widest text-[#0066CC] leading-none">
                                ...
                                <div className="flex flex-col items-start sm:items-end self-stretch sm:self-auto justify-between sm:justify-center border-t sm:border-t-0 border-slate-200/50 pt-3 sm:pt-0">
                                    ...
                                    <button 
                                        ...
                                        className="text-[9px] font-black text-[#0066CC] hover:text-[#0055B3] uppercase tracking-widest flex items-center gap-0.5 mt-2 transition-colors cursor-pointer"
                                    >
                                        ...
                                        <div key={stageItem.id} className="flex flex-col items-center text-center">
                                            ...
                                            <div className="h-6 flex items-center justify-center">
                                                {isCompleted ? (
                                                    ...
                                                    <div className="w-6 h-6 rounded-full bg-[#0066CC] text-white flex items-center justify-center shadow-md">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4 items-start">
                    ...
                    <div className="h-full">
                        <motion.div variants={itemVariants} className="bg-white border border-slate-200/50 rounded-[24px] p-8 shadow-sm transition-all hover:shadow-md relative overflow-hidden flex flex-col h-full min-h-[360px]">
                            ...
                            <div className="grid grid-cols-2 gap-4 flex-1">
                                ...
                                >
                                    <div className="w-9 h-9 rounded-xl bg-sky-50 text-[#0066CC] flex items-center justify-center group-hover:bg-[#0066CC] group-hover:text-white transition-all">
                                ...
                                <button 
                                    ...
                                    className="p-5 rounded-2xl border border-slate-100 bg-slate-50/50 hover:bg-white hover:border-amber-500/20 hover:shadow-md/5 text-left group flex flex-col justify-between h-32 transition-all cursor-pointer"
                                >
                                    <div className="w-9 h-9 rounded-xl bg-slate-100 text-slate-600 flex items-center justify-center group-hover:bg-[#0066CC]/90 backdrop-blur-md border border-white/20 group-hover:text-white transition-all">
                            ...
                            <div className="flex-1 flex flex-col justify-between">
                                ...
                                <div className="bg-slate-50 border border-slate-100 rounded-2xl p-4 text-xs space-y-2">
                                    ...
                                    <div className="w-full bg-slate-200/50 h-1.5 rounded-full overflow-hidden">
                                        <div className="bg-[#0066CC] h-full rounded-full transition-all duration-500" style={{ width: `${activePhase.progress.pct}%` }} />
                                    </div>
                                </div>
                                
                                <button 
                                    onClick={() => setActiveTab('project-journey')}
                                    className="w-full mt-4 py-2.5 px-4 bg-[#0066CC]/90 backdrop-blur-md border border-white/20 hover:bg-[#0055B3] text-white rounded-full text-xs font-bold transition-all flex items-center justify-center gap-1.5 cursor-pointer shadow-sm"
                                >
                ...
                {activeWidgets.includes('ops-intelligence') && isExecution && (
                    <div className="h-full">
                        <motion.div variants={itemVariants} className="bg-white border border-slate-200/50 rounded-[24px] p-8 shadow-sm transition-all hover:shadow-md relative overflow-hidden flex flex-col h-full min-h-[360px]">
                            {/* Accent Line */}
                            <div className="absolute top-0 left-0 right-0 h-[2px] bg-[#0066CC]/90 backdrop-blur-md border border-white/20/20" />
                            ...
                            <div className="space-y-5 flex-1 flex flex-col justify-between">
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <div className="flex items-baseline gap-1.5 mt-1">
                                            <span className="text-2xl font-black text-[#0066CC] tracking-tight">
                                ...
                                {projectContext.riskAlerts && projectContext.riskAlerts.length > 0 && (
                                    <div className="border-t border-slate-100 pt-4">
                                        <div className="flex justify-between items-center mb-2">
                                            ...
                                            <button onClick={() => setActiveTab('timeline')} className="text-[9px] font-black text-[#0066CC] uppercase tracking-wider hover:underline">Resolve →</button>
                                        </div>
                                ...
                                <div className="border-t border-slate-100 pt-4 flex-1 flex flex-col justify-end">
                                    <div className="flex justify-between items-center mb-2">
                                        ...
                                        <button onClick={() => setActiveTab('materials')} className="text-[9px] font-black text-[#0066CC] uppercase tracking-wider hover:underline">Manage →</button>
                                    </div>
                                        ...
                                        return (
                                            <div className="space-y-3 py-6 text-center flex flex-col items-center justify-center">
                                                ...
                                                <button 
                                                    ...
                                                    className="px-4 py-1.5 bg-[#0066CC]/90 backdrop-blur-md border border-white/20 text-white hover:bg-[#0055B3] rounded-full text-[10px] font-extrabold uppercase tracking-widest transition-colors shadow-sm mt-2 cursor-pointer"
                                                >
                                                    Open Site Control
                                                </button>
                                            </div>
                        ...
                        <motion.div variants={itemVariants} className="bg-white border border-slate-200/50 rounded-[24px] p-8 shadow-sm transition-all hover:shadow-md relative overflow-hidden flex flex-col justify-between h-full min-h-[360px]">
                            ...
                            <div className="pt-4 border-t border-slate-100 mt-6">
                                <button 
                                    ...
                                    className="w-full text-center text-xs font-bold text-slate-900 hover:text-[#0055B3] transition-colors flex items-center justify-center gap-1.5"
                                >
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                        ...
                        >
                            ...
                            <div className="p-6 border-t border-slate-100 bg-slate-50 flex gap-3">
                                ...
                                <button 
                                    onClick={() => setIsWidgetModalOpen(false)}
                                    className="px-4 py-2.5 rounded-xl font-bold text-xs bg-[#0066CC] text-white hover:bg-[#0055B3] flex-1 transition-colors shadow-sm"
                                >
                                    Done
                                </button>
                            </div>
