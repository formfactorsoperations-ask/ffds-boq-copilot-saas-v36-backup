                ...
                return (
                  <button
                    ...
                    className={`w-full p-3 rounded-xl border text-left transition-all flex items-center justify-between group ${
                      isSelected
                        ? 'border-[#3D52A0] ring-2 ring-[#3D52A0]/20 bg-sky-50/50 shadow-sm'
                  ...
                  >
                    ...
                    <div className="shrink-0 pl-2">
                      {isSelected ? (
                        <div className="w-5 h-5 rounded-full bg-[#3D52A0] text-white flex items-center justify-center">
          ...
          <div className="lg:col-span-7 flex flex-col space-y-4">
                  ...
                  return (
                    <div key={idx} className="p-2.5 bg-white rounded-lg border border-slate-200/80 shadow-xs flex items-start gap-2.5">
                      <div className="p-1 rounded-md bg-slate-100 text-slate-600 mt-0.5">
                        <Sparkles className="w-3 h-3 text-[#3D52A0]" />
                      </div>
                      <div>
                        <div className="flex items-center gap-2">
            ...
            <div className="space-y-1.5 flex-1 flex flex-col justify-end">
              ...
              <textarea
                ...
                rows={2}
                className="w-full p-2.5 bg-white border border-slate-300 rounded-xl text-xs text-slate-800 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-[#3D52A0]"
              />
            </div>
          </div>
        </div>
          ...
          <div className="text-xs text-slate-500">
            {isChanged ? (
              <span className="flex items-center gap-1.5 font-medium text-slate-700">
                ...
                <strong className="text-[#3D52A0]">{targetDetail.label}</strong>
              </span>
            ) : (
            ...
            <button
              ...
              className={`px-6 py-2 rounded-lg text-xs font-bold transition-all flex items-center gap-1.5 shadow-sm ${
                isChanged && !isSubmitting
                  ? 'bg-[#3D52A0] hover:bg-[#334486] text-white shadow-sky-600/20'
