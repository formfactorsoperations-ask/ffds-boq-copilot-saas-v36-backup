                    ...
                    {q.replies.map((r, i) => (
                      <div
                        ...
                        className={`p-3 rounded-xl text-[11px] leading-relaxed ${
                          r.side === 'studio'
                            ? 'bg-[#3D52A0]/8 border border-[#3D52A0]/20'
                ...
                {q.status !== 'amended' && q.status !== 'withdrawn' && (
                  <div className="space-y-2">
                    <textarea
                      ...
                      className="w-full px-3 py-2.5 border border-slate-200 rounded-xl text-xs outline-none focus:border-[#3D52A0] resize-none bg-white"
                    />
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      <button
                        ...
                        className="px-3.5 py-2 bg-[#3D52A0] hover:bg-[#334486] disabled:bg-slate-300 disabled:cursor-not-allowed text-white text-xs font-bold rounded-xl cursor-pointer flex items-center gap-1.5"
                      >
        ...
        <div className="fixed inset-0 z-[140] flex items-center justify-center p-4 bg-slate-950/70 backdrop-blur-sm">
          <div className="bg-white w-full max-w-2xl rounded-2xl shadow-2xl border border-slate-200 overflow-hidden max-h-[90vh] flex flex-col">
            ...
            <div className="p-5 space-y-4 overflow-y-auto">
              ...
              <div className="p-3.5 rounded-xl bg-[#3D52A0]/8 border border-[#3D52A0]/20">
