        ...
        <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-sm">
            ...
            <div className="bg-slate-50 px-6 py-4 flex items-center justify-between border-b border-slate-200">
                ...
                <div>
                   ...
                   {step.status === 'in_progress' && <span className="bg-sky-100 text-sky-800 text-xs font-bold px-3 py-1 rounded-full">In Progress</span>}
                                ...
                                <div className="flex items-start gap-4 flex-1">
                                    ...
                                    >
                                        {d.checked ? (
                                            ...
                                            <Circle className="w-6 h-6 text-slate-300 hover:text-sky-400" />
                                        )}
                                    </button>
                                    <div>
                    ...
                    <div className="mt-8 flex justify-end">
                        {!showConfirm ? (
                            <div className="relative group">
                                ...
                                {!canComplete && tooltip && (
                                    <div className="absolute bottom-full mb-2 right-0 hidden group-hover:block bg-sky-900 text-white text-xs font-medium px-3 py-2 rounded-lg whitespace-nowrap">
                                        {tooltip}
                                    </div>
                                )}
                            </div>
