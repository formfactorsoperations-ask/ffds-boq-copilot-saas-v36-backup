        ...
        <div className="max-w-4xl mx-auto py-8 px-4">
            <div className="mb-8">
                <div className="flex items-center justify-between relative">
                    ...
                    <div 
                        className="absolute left-0 top-1/2 -translate-y-1/2 h-1 bg-slate-900 rounded-full z-0 transition-all duration-500"
                    ...
                    {[1, 2, 3, 4].map((num) => (
                        <div 
                            ...
                            className={`relative z-10 w-8 h-8 rounded-full flex items-center justify-center text-xs font-black transition-colors ${
                                step >= num ? 'bg-slate-900 text-white' : 'bg-slate-200 text-slate-500'
                            }`}
                        >
                            {num}
                        </div>
            ...
            <div className="bg-white rounded-[2rem] shadow-sm border border-slate-200 overflow-hidden min-h-[500px] flex flex-col relative w-full">
                <AnimatePresence mode="wait">
                    {step === 1 && (
                        <motion.div key="step1" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="p-8 md:p-10 flex-grow space-y-8">
                            <div>
                                <h1 className="text-3xl font-black text-slate-900">Welcome! Let's brand your workspace.</h1>
                                ...
                                <div className="space-y-6 text-sm">
                                    ...
                                    <div>
                                        ...
                                        <label className="border-2 border-dashed border-slate-200 rounded-xl h-24 flex items-center justify-center cursor-pointer hover:bg-slate-50 hover:border-slate-300 transition-colors relative overflow-hidden group">
                                            ...
                                            {logo ? <img src={logo} alt="Logo" className="h-full w-full object-contain p-2" /> : <span className="text-slate-400 group-hover:text-slate-900 font-bold tracking-tight">Upload Logo Image</span>}
                                        </label>
                                    </div>
                                </div>
                                <div className="space-y-6 text-sm">
                                    <h3 className="font-black text-slate-900 uppercase tracking-widest text-xs mb-4">Legal & Contact</h3>
                                    <div>
                    ...
                    {step === 2 && (
                        <motion.div key="step2" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="p-8 md:p-10 flex-grow space-y-6">
                            <div>
                                <h1 className="text-3xl font-black text-slate-900">Set Operational Defaults.</h1>
                            ...
                            <div className="max-w-md space-y-6 text-sm">
                                ...
                                <div className="p-6 bg-slate-50 border border-slate-200 rounded-2xl">
                                    ...
                                    <ul className="text-xs text-slate-800 space-y-2 font-mono bg-white p-4 rounded-xl border border-slate-200">
                    ...
                    {step === 3 && (
                        <motion.div key="step3" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="p-8 md:p-10 flex-grow space-y-6">
                            <div>
                                <h1 className="text-3xl font-black text-slate-900">Payment Accounts.</h1>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input type="text" value={accountNumber} onChange={e => setAccountNumber(e.target.value)} className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 font-mono focus:ring-2 focus:ring-slate-900 outline-none" />
                                        </div>
                                        <div>
                                            <label className="block font-bold text-slate-700 mb-2">IFSC Code</label>
                                            <input type="text" value={ifscCode} onChange={e => setIfscCode(e.target.value)} className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 font-mono focus:ring-2 focus:ring-slate-900 outline-none" />
                                        </div>
                                    </div>
                                </div>
                                <div className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <label className="border-2 border-dashed border-slate-200 rounded-xl h-32 flex items-center justify-center cursor-pointer hover:bg-slate-50 hover:border-slate-300 transition-colors relative overflow-hidden group">
                                            ...
                                            {qrCodeImage ? <img src={qrCodeImage} alt="QR Code" className="h-full w-full object-contain p-2" /> : <div className="text-center"><span className="text-slate-400 group-hover:text-slate-900 font-bold block">Upload QR Code</span><span className="text-xs text-slate-400">Optional</span></div>}
                                        </label>
                                    </div>
                                </div>
                            </div>
                    ...
                    {step === 4 && (
                        <motion.div key="step4" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="p-8 md:p-10 flex-grow space-y-6">
                            <div>
                                <h1 className="text-3xl font-black text-slate-900">Initialize Item Bank.</h1>
                            ...
                            <div className="grid grid-cols-1 gap-6 mt-8 max-w-xl">
                                <label className="relative p-6 bg-white border-2 border-slate-900 rounded-2xl cursor-pointer hover:bg-slate-50 transition-colors flex items-start gap-4">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-slate-900 text-lg">Use FFDS Master Templates (Recommended)</h4>
                                ...
                                <label className="relative p-6 bg-slate-50 border border-slate-200 rounded-2xl cursor-pointer hover:bg-slate-100 transition-colors flex items-start gap-4 opacity-50">
                                    ...
                                    <div>
                                        <div className="flex items-center gap-3">
                                            <h4 className="font-bold text-slate-900 text-lg">Upload custom Excel BOQ</h4>
                ...
                <div className="p-8 border-t border-slate-100 bg-slate-50 flex justify-between items-center mt-auto">
                    <button 
                        onClick={handlePrev} 
                        disabled={step === 1}
                        className={`px-8 py-3 rounded-xl font-bold text-sm transition-all ${step === 1 ? 'opacity-0 cursor-default' : 'text-slate-500 hover:text-slate-900 bg-white border border-slate-200 shadow-sm hover:shadow-md'}`}
                    >
                        Back
                    </button>
                    {step < 4 ? (
                        <button 
                            ...
                            className={`px-8 py-3 rounded-xl font-bold text-sm shadow-md transition-all flex items-center gap-2 ${step === 1 && !isStep1Valid ? 'bg-slate-300 text-slate-500 cursor-not-allowed' : 'bg-slate-900 text-white hover:bg-slate-800 hover:scale-[1.02] active:scale-[0.98]'}`}
                        >
                            Continue →
                        </button>
                    ) : (
