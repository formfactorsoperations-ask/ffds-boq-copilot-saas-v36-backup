                    ...
                    return (
                        <div 
                            ...
                            className={`tier-option-card rounded-3xl p-6 flex flex-col cursor-pointer transition-all duration-300 relative
                                ${isActive 
                                    ? 'border-2 border-indigo-900 bg-white shadow-lg scale-[1.02] z-10 ring-2 ring-slate-100' 
                                    : isRecommended 
                        ...
                        >
                            ...
                            <div className={`viewing-badge absolute -top-3 left-1/2 -translate-x-1/2 bg-indigo-900 text-white text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-widest shadow-md ${isActive ? '' : 'hidden'}`}>
                                Viewing Details
                            </div>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <div className={`rec-badge px-3 py-1 rounded-full bg-indigo-950 text-white text-[11px] font-extrabold ${isRecommended && !isActive ? '' : 'hidden'}`}>Recommended</div>
                            </div>
