                ...
                <div className="flex h-full">
                    ...
                    <div className="w-1/2 flex flex-col justify-center items-start pl-8 border-l-4 border-orange-400">
                        <div className="text-center mb-12">
                            ...
                            <h2 className="text-3xl font-bold tracking-widest my-1 border-y-2 border-[#0055B3] py-2">{orgData?.orgName?.toUpperCase() || 'FORM FACTORS'}</h2>
                ...
                <Page orgData={orgData}>
                    ...
                    <div className="space-y-6">
                        {projectContext.proposalDecision.options.map(opt => {
                            ...
                            return (
                                <div key={opt.id} className={`border-2 p-6 rounded-xl ${isSelected ? 'border-[#0055B3] bg-gray-50' : 'border-gray-200'}`}>
                                    <div className="flex items-start gap-4">
                                        <div className={`w-6 h-6 border-2 flex items-center justify-center font-bold text-sm ${isSelected ? 'border-[#0055B3] bg-[#0066CC]/90 backdrop-blur-md border border-white/20 text-white' : 'border-gray-300'}`}>
                                            {isSelected ? '✓' : ''}
                                        </div>
                                        <div>
                    ...
                    <div className="mt-12 pt-8 border-t-2 border-[#0055B3] flex justify-between items-end">
                        <div>
                            <p className="text-sm font-bold uppercase mb-8">Client Signature</p>
                            <div className="w-48 border-b border-[#0055B3]"></div>
                        </div>
                        <div>
