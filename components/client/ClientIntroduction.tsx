                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                    <div className="lg:col-span-7">
                        ...
                        <div className="mb-8 flex items-center gap-4">
                            ...
                            <>
                                <h2 className="text-2xl font-bold text-slate-800 mb-4">{l15Content.title}</h2>
                                <p className="text-slate-600 text-base md:text-lg leading-relaxed mb-8 whitespace-pre-line">
                                    {l15Content.text}
                                </p>
                            </>
                    ...
                    <div className="lg:col-span-5 hidden md:block">
                        <div className="rounded-3xl border border-slate-200 bg-white shadow-xl shadow-slate-200/50 p-8 relative overflow-hidden">
                            ...
                            {isFixedPrice && executionTotal !== undefined && designFee !== undefined && (
                                <div className="mt-4 flex items-center justify-between px-4 py-3 bg-sky-50/70 rounded-xl text-xs border border-sky-100/50">
                                    <div className="flex flex-col">
                                        <span className="text-slate-500 font-bold tracking-wider uppercase text-[9px]">Execution Core</span>
                                        <span className="font-extrabold text-slate-900 text-base">{formatClientValue(executionTotal)}</span>
                                    </div>
                                    ...
                                    <div className="flex flex-col text-right">
                                        ...
                                        <span className="font-extrabold text-slate-900 text-base">{formatClientValue(designFee)}</span>
                                    </div>
                                </div>
                            )}
