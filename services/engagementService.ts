...
import { TermsSettings, TermsSection, PaymentStructure, ProjectEngagement } from '../types';

export const STANDARD_SECTIONS: TermsSection[] = [
    { n: 1, title: "About {{studioName}}", blocks: [
        { type: "clause", ref: "1.1", text: "{{studioName}} (\"the Studio\") is a design-led practice founded in {{studioFoundedYear}}, providing end-to-end architectural design, interior design, and turnkey execution services. Every project is approached with clarity, care, and purposeful intent — from the first conversation to the final handover." },
    ...
    { n: 2, title: "The Design Process", blocks: [
        { type: "clause", ref: "2.1", text: "{{studioName}} follows a structured process for every project. The specific phases applicable to a given project are defined in the Design Agreement. The standard phases are: Discovery Workshop — Space Planning — Concept Development & Visualisation — Working Drawings & BOQ — Execution — Handover. Not all phases apply to every project type." },
        { type: "clause", ref: "2.2", text: "The client agrees to provide timely feedback, approvals, and inputs at each stage. Project delays caused by late client feedback or approvals do not constitute delays attributable to the Studio and may impact the project timeline at no liability to {{studioName}}." },
        { type: "clause", ref: "2.3", text: "Once the Design Brief is formally frozen at the conclusion of the Discovery phase, any changes to agreed scope, room requirements, or design direction must be submitted as a formal Change Request. The Studio will communicate cost and timeline impact within {{changeRequestResponseDays}} working days of receiving a Change Request." },
    ...
    { n: 3, title: "Advance Payment Framework", blocks: [
        ...
        { type: "clause", ref: "3.3", text: "The Studio reserves the right to pause all site activity and design work if any advance payment remains unpaid more than {{paymentOverdueGraceDays}} days beyond its due date, without liability for any project delay arising thereof. Activity resumes within {{resumeAfterPaymentDays}} working days of payment clearance." },
        { type: "clause", ref: "3.4", text: "All payments are to be made via {{paymentMethods}} to the bank account specified on the invoice. Payment is considered received only upon clearance into the Studio's designated account. GST at {{gstRate}}% applies to all amounts unless otherwise specified in the Design Agreement." },
    ...
    { n: 5, title: "Change Requests & Scope Additions", blocks: [
        { type: "clause", ref: "5.1", text: "Any change to agreed scope — addition, deletion, or modification — requires a formal Change Request. The Studio will assess and communicate cost and timeline impact within {{changeRequestResponseDays}} working days." },
    ...
    { n: 6, title: "Pre-Handover Inspection, Snag Policy & Final Advance", blocks: [
        ...
        { type: "clause", ref: "6.3", text: "Snag items are addressed within the warranty period. Snags are resolved according to defined timeframes by category. The Studio's commitment to resolving legitimate snag items exists independently of payment status." },
    ...
    { n: 7, title: "Warranty", blocks: [
        { type: "clause", ref: "7.1", text: "{{studioName}} provides workmanship warranty on completed execution work from the date of formal handover. Warranty periods by trade are specified in the Design Agreement and vary by project scope." },
    ...
    { n: 8, title: "Intellectual Property", blocks: [
        { type: "clause", ref: "8.1", text: "All design drawings, 3D visualisations, material specifications, and documentation created by {{studioName}} remain the intellectual property of {{studioName}}. Upon receipt of all due payments in full, the client receives a non-exclusive licence to use the design for the agreed project site only." }
    ]},
    ...
    { n: 10, title: "Dispute Resolution", blocks: [
        { type: "clause", ref: "10.1", text: "Disputes are first to be resolved through good-faith mediation. If unresolved within {{disputeMediationDays}} days, disputes are subject to the exclusive jurisdiction of the courts in {{disputeJurisdiction}}." }
    ]},
